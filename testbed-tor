...
env.roledefs = {
    ...
    # 'vgw': [host4, host5], # Optional, Only to enable VGW. Only compute can support vgw
     'tsn': [host4], # Optional, Only to enable TSN. Only compute can support TSN
     'toragent': [host4],# Optional, Only to enable Tor Agent. Only compute can
    # support Tor Agent
    #   'backup':[backup_node],  # only if the backup_node is defined
}

env.hostnames = {
    'all': ['a0s1', 'a0s2', 'a0s3','a0s4', 'a0s5','backup_node']
}
...
env.tor_agent = {host4:[{
                    'tor_ip':'17.1.1.236',
                    'tor_agent_id':'1',
                    'tor_agent_name':'compute-1',
                    'tor_type':'ovs',
                    'tor_ovs_port':'9999',
                    'tor_ovs_protocol':'tcp',
                    'tor_tsn_ip':'17.1.1.236',
                    'tor_tsn_name':'compute-1',
                    'tor_name':'ovs',
                    'tor_tunnel_ip':'4.4.4.4',
                    'tor_vendor_name':'ovs',
                    'tor_product_name':'ovs',
