...
from Flask_Framework_Cookbook.Chapter_10.my_app import Product, Category, ProductForm, CategoryForm
from Flask_Framework_Cookbook.Chapter_10.my_app import db, app, ALLOWED_EXTENSIONS, babel
