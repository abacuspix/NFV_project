...
from Flask_Framework_Cookbook.Chapter_10.my_app import Product, Category, product_created, \
    category_created
from Flask_Framework_Cookbook.Chapter_10.my_app import db, app, es, cache, mail, celery
