...
from Flask_Framework_Cookbook.Chapter_10.my_app import User, RegistrationForm, LoginForm, OpenIDForm
from Flask_Framework_Cookbook.Chapter_10.my_app import db, login_manager, oid, facebook, google, twitter
