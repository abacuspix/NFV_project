...
import config
from mockdbhelper import MockDBHelper as DBHelper if config.test else DBHelper
...
def register():
    ...
    if form.validate():
        ...
        return render_template(
            "home.html", loginform=LoginForm(), registrationform=form, onloadmessage="Registration successful. Please log in."
        )
    return render_template("home.html", loginform=LoginForm(), registrationform=form)
...
def new_request(tid):
    ...
    return "A request is already pending for this table. Please be patient, a waiter will assist you soon."
